...
const pages = {
  privacy: {
    ...
    sections: [
      ...
      ["Where data is processed", "Account and cloud data are processed by Supabase. The website is currently delivered through GitHub Pages. The app also keeps an on-device cache and short local backups so logging can survive a weak gym connection."],
      ["Retention and control", "Cloud history snapshots are kept for approximately 30 days. On-device snapshots are kept for approximately 7 days. You can export your data, adjust group sharing, disconnect Apple Health, sign out and clear this device, or permanently delete your account from Settings."],
