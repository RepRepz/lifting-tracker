...
const pages = {
  privacy: {
    ...
    sections: [
      ...
      ["Retention and control", "Daily recovery snapshots are kept for approximately 30 days. Change-by-change recovery history keeps up to 500 versions per account within a 90-day window; cleanup happens during later saves. This browser can also keep up to 14 daily recovery copies. You can export your current tracker data, adjust group sharing, disconnect Apple Health, sign out and clear this device, or request permanent account deletion from Settings. Email accounts must confirm deletion through a short-lived email link."],
